    ...
    public partial class TextEditorTabPage : UserControl
    {
        ...
        private void NumLineas_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (TxtCodigo.Lines.Length > 0)
            {
                ...
                {
                    int aux = i + 1;
                    e.Graphics.DrawString(aux.ToString(), TxtCodigo.Font, Brushes.DeepSkyBlue, numLineas.Width - (e.Graphics.MeasureString(aux.ToString(), TxtCodigo.Font).Width + 10), Altura);
            ...
            {
                e.Graphics.DrawString("1", TxtCodigo.Font, Brushes.DeepSkyBlue, numLineas.Width - (e.Graphics.MeasureString("1", TxtCodigo.Font).Width + 10), Altura);
            }
        }
